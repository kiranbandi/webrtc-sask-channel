...
function startSendingDataToPeer(peer) {
    ...
    function send_message() {
        ...
        //console.log(sendMessage);
        connectedPeer.send(JSON.stringify({ dataType, sendMessage, 'remoteID': connectedPeerID }))
        ...
        if ((i % 1000) == 0) {
            ...
            if (i == (message_rates_length * message_sizes_length * 1000)) {
                ...
                connectedPeer.send(JSON.stringify({ dataType, thxMessage, 'remoteID': connectedPeerID }))
